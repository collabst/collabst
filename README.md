...
> Furthermore, as stated in the [license](LICENSE), we do not provide any garantees regarding the use of Collabst: If your organization needs to set up a reliable service with professional technical support, we recommand contacting the Typst team directly, in order to get a proper paid plan for self-hosting the official web app.*
...
<h3 align="center"> Collaborative Editing &amp; Support for Comments</h3>
<div align="center">
  <table align="center">
    <tr>
      <td style="padding:0;">
        <img src="assets/screenshots/collab-editing.png" alt="collab editing screenshot" width="300" />
      </td>
      <td style="padding:0;">
        <img src="assets/screenshots/comments.png" alt="comments screenshot" width="450" />
      </td>
    </tr>
  </table>
</div>
...
## 👋 Contributing
We are looking for contributions to the Collabst Project ! There are many features that can still be added or ironed out, and certainly some bugs that could be fixed.
